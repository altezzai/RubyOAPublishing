...
event_logic.Events.register_for_event(
    event_logic.Events.ON_EDITOR_MANUALLY_ASSIGNED,
    transactional_emails.send_editor_manually_assigned,
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_ARTICLE_UNASSIGNED,
    transactional_emails.send_editor_unassigned_notice,
)

# Review
event_logic.Events.register_for_event(
    event_logic.Events.ON_REVIEWER_REQUESTED_NOTIFICATION,
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_REVIEWER_ACCEPTED,
    transactional_emails.send_reviewer_accepted_or_decline_acknowledgements,
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_REVIEWER_DECLINED,
    transactional_emails.send_reviewer_accepted_or_decline_acknowledgements,
)
event_logic.Events.register_for_event(
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_ARTICLE_DECLINED, transactional_emails.send_article_decision
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_ARTICLE_UNDECLINED, transactional_emails.send_article_decision
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_ARTICLE_ACCEPTED, transactional_emails.send_article_decision
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_DRAFT_DECISION, transactional_emails.send_draft_decison
)
event_logic.Events.register_for_event(
...
# Copyediting
event_logic.Events.register_for_event(
    event_logic.Events.ON_COPYEDIT_ASSIGNMENT,
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_COPYEDIT_DELETED, transactional_emails.send_copyedit_deleted
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_COPYEDITOR_DECISION,
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_COPYEDIT_REOPEN, transactional_emails.send_copyedit_reopen
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_COPYEDIT_ACKNOWLEDGE, transactional_emails.send_copyedit_ack
)

# Production
event_logic.Events.register_for_event(
    event_logic.Events.ON_TYPESET_TASK_ASSIGNED,
    transactional_emails.send_typeset_assignment,
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_TYPESETTER_DECISION,
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_PRODUCTION_COMPLETE,
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_PROOFING_TYPESET_DECISION,
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_EDIT_PROOFING_TASK, transactional_emails.edit_proofing_task
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_NOTIFY_PROOFREADER, transactional_emails.notify_proofreader
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_PROOFREADER_TASK_DECISION,
    transactional_emails.send_proofreader_decision,
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_COMPLETE_PROOFING_TASK,
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_PROOFING_ACK, transactional_emails.send_proofing_ack
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_PROOFING_COMPLETE, transactional_emails.send_proofing_complete
)
event_logic.Events.register_for_event(
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_AUTHOR_PUBLICATION,
    transactional_emails.send_author_publication_notification,
)

# Send notifications to registered users.
event_logic.Events.register_for_event(
    event_logic.Events.ON_ARTICLE_SUBMITTED, journal_logic.fire_submission_notifications
)
event_logic.Events.register_for_event(
    event_logic.Events.ON_ARTICLE_ACCEPTED, journal_logic.fire_acceptance_notifications
)

# Preprints
event_logic.Events.register_for_event(
    event_logic.Events.ON_PREPRINT_SUBMISSION, transactional_emails.preprint_submission
)
...
event_logic.Events.register_for_event(
    event_logic.Events.ON_REVIEWER_REQUESTED, workflow_tasks.do_review_task
)

event_logic.Events.register_for_event(
    event_logic.Events.ON_REVIEWER_ACCEPTED, workflow_tasks.perform_review_task
)

event_logic.Events.register_for_event(
    event_logic.Events.ON_ARTICLE_ACCEPTED, workflow_tasks.create_copyedit_task
)

event_logic.Events.register_for_event(
    event_logic.Events.ON_WORKFLOW_ELEMENT_COMPLETE, workflow.workflow_element_complete
)

event_logic.Events.register_for_event(
    event_logic.Events.ON_ARTICLE_PUBLISHED,
    journal_logic.send_article_to_knowledge_commons,
)
